...
// Buscar informação à tabela Tickets
$tickets_query = "SELECT * FROM tickets where id_utilizador = $id_user";
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="p-4 editData">
                                            <div class="mb-4">
                                                <h5 class="mb-4">Estado dos pedidos</h5>
                                                <div class="row g-3">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td><?= $tickets['data'] ?></td>
                                                                    <td> <button class="btn btn-perfil"
                                                                            onclick="window.location.href='ticket.php?id=<?= $tickets['id_ticket'] ?>'">
                                                                            Ver
                                                                        </button></td>
                                                                </tr>
                                                            <?php endwhile; ?>
